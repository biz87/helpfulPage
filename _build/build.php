...
class helpfulPagePackage
{
    ...
    /**
     * helpfulPagePackage constructor.
     *
     * @param $core_path
     * @param array $config
     */
    ...
    {
        /** @noinspection PhpIncludeInspection */
        $menus = include($this->config['elements'] . '_menus.php');
        if (!is_array($menus)) {
...
$install = new helpfulPagePackage(MODX_CORE_PATH, $config);
